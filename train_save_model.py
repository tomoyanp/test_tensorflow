...
train_save_model_wrapper(base_time, table_layout, output_train_index, learning_span, window_size, model_filename, weight_filename, normalization_filename)

# 1h train
table_layout = "1h"
output_train_index = 8
learning_span = 24*200
window_size = 24*5
